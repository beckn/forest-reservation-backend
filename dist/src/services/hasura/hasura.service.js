...
let HasuraService = class HasuraService {
    constructor(logger) {
        this.logger = logger;
        this.hasuraUrl = process.env.HASURA_URL;
        this.adminSecretKey = process.env.HASURA_GRAPHQL_ADMIN_SECRET;
    ...
    User(where: {role: {_eq: "provider"}}) {
      ...
      reason
        ...
        try {
            ...
            throw new common_1.HttpException('Unable to Create Admin', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async createProviderUser(providerUser) {
      ...
      insert_Provider(objects: {user_id: $user_id, organization: $organization, source_code:$source_code}) {
        ...
        try {
            ...
            throw new common_1.HttpException('Unabe to creatre Provider user', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async createSeekerUser(seeker) {
      ...
      insert_Seeker(objects: {user_id: $user_id, email: $email, name: $name ,age: $age, gender: $gender, phone: $phone}) {
        ...
        try {
            ...
            throw new common_1.HttpException('Unabe to creatre Seeker user', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async updateapprovalStatus(id, user) {
      ...
      update_User_by_pk(pk_columns: { id: $id }, _set: { approved: $approved, reason: $reason }) {
        ...
        try {
            ...
            throw new common_1.HttpException('Unable to approved User', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async updatePassword(id, password) {
      ...
      update_User_by_pk(pk_columns: { id: $id }, _set: { password: $password}) {
        ...
        try {
            ...
            throw new common_1.HttpException('Unable to update password!', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    `;
        try {
            ...
            throw new common_1.HttpException('User is Not approved', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    `;
        try {
            ...
            throw new common_1.HttpException(userResponse, common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async findOne(email) {
        console.log(email);
    ...
    `;
        try {
            ...
            const response = await this.queryDb(query, Object.assign({ user_id: id }, createContentdto));
            console.log("response", response);
            return response;
        }
        catch (error) {
            throw new common_1.HttpException('Failed to create Content', common_1.HttpStatus.NOT_FOUND);
        }
    }
    ...
    `;
        try {
            console.log("Response ", createContentdto);
            const response = await this.queryDb(query, Object.assign({ seeker_id: id }, createContentdto));
            console.log("response", response);
            return response;
        }
        catch (error) {
    ...
    async getContent(id) {
      ...
      fln_content(where: {user_id: {_eq: ${id}}}) {
        ...
        try {
            ...
            this.logger.error("Something Went wrong in creating Admin", error);
            throw new common_1.HttpException('Unable to Fetch content!', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    `;
        try {
            const response = await this.queryDb(query, Object.assign({ id: id }, createContentdto));
            console.log(response);
            return response;
        }
        catch (error) {
            throw new common_1.HttpException('Failed to Update Profile', common_1.HttpStatus.NOT_MODIFIED);
        }
    }
    ...
    `;
        try {
            ...
            throw new common_1.HttpException("Something Went wrong in deleting content", common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async createCollection(provider_id, body) {
        ...
        try {
            ...
            this.logger.error("Something Went wrong in creating User", error);
            throw new common_1.HttpException("Something Went wrong in creating User", common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    `;
        try {
            ...
            throw new common_1.HttpException("Something Went wrong in content list", common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    `;
        try {
            ...
            throw new common_1.HttpException("Something Went wrong in deleting collection", common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async queryDb(query, variables) {
        try {
            const response = await axios_1.default.post(this.hasuraUrl, {
                query,
                variables,
            }, {
                headers: {
    ...
    async createBookmark(seeker_id, body) {
        ...
        try {
            ...
            throw new common_1.HttpException("Something Went wrong in creating Bookmark", common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    `;
        try {
            ...
            const response = await this.queryDb(query, Object.assign({ provider_id: provider_id }, scholarship));
            console.log("response", response);
            return response;
        }
        catch (error) {
            throw new common_1.HttpException('Failed to create scholarship', common_1.HttpStatus.NOT_FOUND);
        }
    }
    async getScholarship(provider_id) {
      ...
      scholarship_content(where: {provider_id: {_eq: ${provider_id}}}) {
        ...
        try {
            ...
            throw new common_1.HttpException('Unabe to create Seeker configuration', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async editScholarshipById(id, provider_id, scholarship) {
      ...
      returning {
        ...
        try {
            console.log("scholarship ", scholarship);
            const response = await this.queryDb(query, Object.assign({ id: id, provider_id: provider_id }, scholarship));
            console.log("response", response);
            return response;
        }
        catch (error) {
    ...
    `;
        try {
            const response = await this.queryDb(query, Object.assign({ user_id }, body));
            console.log("response", response);
            return response;
        }
        catch (error) {
    ...
    `;
        try {
            ...
            throw new common_1.HttpException('Unabe to get Seeker configuration', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    ...
    async getImageUrl(imageId) {
        try {
            ...
            this.logger.error("Something Went wrong in creating Admin", error);
            throw new common_1.HttpException('Failed to Fetch image url!', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    async findClimateContent(filter) {
        var _a;
        ...
        if (filter.name && filter.name != "") {
            ...
            for (let i = 0; i < searchKeys.length; i++) {
                if (searchKeys[i].length)
                    filterQ += `
        {provider_description: {_ilike: "%${searchKeys[i]}%"}},
        {title: {_ilike: "%${searchKeys[i]}%"}},
        {provider_name: {_ilike: "%${searchKeys[i]}%"}},
        {locations:{_cast: {String: {_ilike: "%${searchKeys[i]}%"}}}},
        {datapoint:{_cast: {String: {_ilike: "%${searchKeys[i]}%"}}}},
        {spatial_coverage:{_cast: {String: {_ilike: "%${searchKeys[i]}%"}}}},`;
            }
            filterQ = filterQ.slice(0, filterQ.length - 1) + `]`;
        }
        if ((_a = filter === null || filter === void 0 ? void 0 : filter.locations) === null || _a === void 0 ? void 0 : _a.length)
            filterQ += ` locations: {_contains: ${JSON.stringify(filter.locations)}}`;
        if (filter.operation && filter.operation != "")
            filterQ += ` provider_operation: {_like: "${filter.operation}%"}`;
        filterQ += `}`;
        const query = `query MyQuery {
    ...
    async findClimateContentById(id) {
        console.log("findClimateContentById  > ", id);
        const query = `query MyQuery {
      ${this.dbName}(where: {id: {_eq: ${id}}}) {
        ...
        try {
            const response = await this.queryDb(query);
            return response.data[`${this.dbName}`] || [];
        }
        catch (error) {
            this.logger.error("Something Went wrong in creating Admin", error);
            throw new common_1.HttpException('Unable to Fetch content!', common_1.HttpStatus.BAD_REQUEST);
